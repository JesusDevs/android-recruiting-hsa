...
import com.accenture.concrete.ui.screen.items.ItemRepo
...
fun HomeScreen(
    ...
    val repoPagingItems: LazyPagingItems<Item> = viewModel.gitHubRepositoryState.collectAsLazyPagingItems()
    Scaffold(
        topBar = {
            Row(
                modifier = Modifier
        ...
        LazyColumn(
            ...
            items(repoPagingItems.itemCount) { index ->
                ItemRepo(
                    itemEntity = repoPagingItems[index]!!,
                )
            }
